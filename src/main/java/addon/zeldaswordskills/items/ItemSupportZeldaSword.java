...
public class ItemSupportZeldaSword extends ItemZeldaSword{

	public ItemSupportZeldaSword(ToolMaterial material, float bonusDamage)
	{
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int slot, boolean isHeld)
    {
    	if(!world.isRemote)
    	{
    		if(entity instanceof EntityPlayer)
    		{
    			...
    			{
    				player.inventory.consumeInventoryItem(AddonItems.swordSupport);
